  ...
  <div class="window-height window-width bg-light row items-center justify-center">
    <div class="row col-xs-10 col-sm-8 col-md-6 col-lg-4 shadow-4 bg-white sm-gutter" style="padding-right: 16px; padding-bottom: 16px">
      ...
      <template v-if="registered">
        ...
        <p style="padding-left: 1rem">Er is een mail verzonden naar het opgegeven mailadres met een verificatielink.</p>
        <div class="col-12">
          <q-btn class="no-margin full-width" @click="cancelRegister" color="primary">Naar login</q-btn>
        </div>
      </template>
    </div>
  </div>
